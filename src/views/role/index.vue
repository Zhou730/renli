<template>
    <div class="container">
            ...
            <el-dialog width="500px" title="新增角色" :visible.sync="showDialog" @close="btnCancel">
                ...
                <el-form ref="roleForm" :model="roleForm" :rules="rules" label-width="120px">
                    ...
                    <el-form-item prop="description" label="角色描述">
                        <el-input v-model="roleForm.description" type="textarea" :rows="3" style="width:300px"
                            size="mini" />
                    </el-form-item>
                    <el-form-item>
        ...
        <el-dialog :visible.sync="showPermissionDialog" title="分配权限">
            <!-- 放置权限数据 -->
            <el-tree node-key="id" :data="permissionData" :props="{ label: 'name' }" show-checkbox default-expand-all
                ref="permTree" :default-checked-keys="permIds" />

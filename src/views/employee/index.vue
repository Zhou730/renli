...
import { delEmployee, getEnableRoleList, assignRole, getEmployeeDetail } from '@/api/employee'
import { getDepartment, exportEmployee } from '@/api/user'
...
export default {
  ...
  methods: {
    ...
    async exportEmployee() {
      const result = await exportEmployee()//导出
